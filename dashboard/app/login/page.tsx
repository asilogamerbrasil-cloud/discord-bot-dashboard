...
function LoginContent() {
  ...
  const mensagensErro: Record<string, string> = {
    token: 'Erro ao autenticar com Discord. Verifique as credenciais.',
    user: 'Erro ao obter dados do usuario.',
    sem_codigo: 'Codigo de autorizacao nao encontrado.',
  ...
  return (
    <div className="min-h-screen bg-[#1E1F22] flex items-center justify-center p-4">
      <div className="bg-[#2B2D31] border border-[#313338] rounded-lg p-8 w-full max-w-md text-center">
        <div className="w-16 h-16 rounded-full bg-[#5865F2] flex items-center justify-center mx-auto mb-6">
